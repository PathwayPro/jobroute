...
const Logo = ({ variant }: { variant: 'primary' | 'secondary' }) => {
  ...
  return (
    <div className={style} style={{ backgroundImage: 'url(/img/logo-primary.svg)' }}>
      <Image src={variant === 'primary' ? pathPrimary : pathSecondary} width={139} height={24} alt="Job Route" />
    </div>
  )
}
